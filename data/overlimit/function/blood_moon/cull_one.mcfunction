...
execute unless entity @a[predicate=overlimit:in_overworld,gamemode=!spectator,distance=..25] run return run function overlimit:blood_moon/cull_despawn
...
execute as @a[predicate=overlimit:in_overworld,gamemode=!spectator,distance=..25] run function overlimit:blood_moon/cull_check_y
