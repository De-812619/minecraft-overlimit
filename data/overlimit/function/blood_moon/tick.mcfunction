...
execute unless score #bm_active overlimit.const matches 1 if score #bm_checked overlimit.const matches 0 if score #bm_tod overlimit.const matches 12000..13000 run function overlimit:blood_moon/try_start
