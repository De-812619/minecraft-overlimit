...
execute as @e[tag=overlimit.blood_moon,tag=overlimit.bm_ow,tag=!overlimit.bm_scored] run function overlimit:blood_moon/credit_if_dead
...
execute as @e[tag=overlimit.blood_moon,tag=overlimit.bm_ow,tag=overlimit.crisis,tag=!overlimit.bm_crisis] run tag @s add overlimit.bm_crisis
execute as @e[tag=overlimit.blood_moon,tag=overlimit.bm_ow,tag=overlimit.disaster,tag=!overlimit.bm_disaster] run tag @s add overlimit.bm_disaster
execute as @e[tag=overlimit.blood_moon,tag=overlimit.bm_ow,tag=!overlimit.crisis,tag=!overlimit.disaster,tag=!overlimit.bm_normal] run tag @s add overlimit.bm_normal
