...
execute as @e[tag=overlimit.blood_moon,tag=overlimit.bm_bw,tag=!overlimit.bm_scored] run function overlimit:blood_world/credit_if_dead
...
execute as @e[tag=overlimit.blood_moon,tag=overlimit.bm_bw,tag=overlimit.crisis,tag=!overlimit.bm_crisis] run tag @s add overlimit.bm_crisis
execute as @e[tag=overlimit.blood_moon,tag=overlimit.bm_bw,tag=overlimit.disaster,tag=!overlimit.bm_disaster] run tag @s add overlimit.bm_disaster
execute as @e[tag=overlimit.blood_moon,tag=overlimit.bm_bw,tag=!overlimit.crisis,tag=!overlimit.disaster,tag=!overlimit.bm_normal] run tag @s add overlimit.bm_normal
