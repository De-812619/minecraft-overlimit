...
execute if score #bm_tod overlimit.const matches 23460.. run return run function overlimit:blood_world/end_dawn
execute if score #bm_tod overlimit.const matches ..11999 run return run function overlimit:blood_world/end_dawn
