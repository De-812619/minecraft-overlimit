execute if score #cc_combat overlimit.const matches 0 run return run bossbar set overlimit:city_clamp name {"translate": "overlimit.bossbar.city_clamp.gather","color":"blue","bold":true}
