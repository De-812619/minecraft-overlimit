...
title @a[predicate=overlimit:in_the_end] subtitle {"translate": "overlimit.subtitle.clamp_fail","color":"red"}
tellraw @a[predicate=overlimit:in_the_end] {"translate": "overlimit.msg.cc.fail","color":"red"}
