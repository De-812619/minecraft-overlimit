...
tellraw @a[predicate=overlimit:in_the_end] ["",{"text":"シティクランプが始まった。","color":"blue"},{"text":" エンドシティ（","color":"aqua"},{"nbt":"target.x","storage":"overlimit:cc"},{"text":", ","color":"aqua"},{"nbt":"target.y","storage":"overlimit:cc"},{"text":", ","color":"aqua"},{"nbt":"target.z","storage":"overlimit:cc"},{"text":"）へ向かえ。","color":"aqua"},{"text":" （ヒート ","color":"gold"},{"score":{"name":"#heat","objective":"overlimit.const"},"color":"gold"},{"text":"）","color":"gold"}]
tellraw @a[predicate=overlimit:in_the_end] {"text":"32マス以内に入ると戦闘が始まる。","color":"gray"}
