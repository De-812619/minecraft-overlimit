...
execute unless score #cc_active overlimit.const matches 1 if score #cc_dwell overlimit.const >= #cc_dwell_max overlimit.const run function overlimit:city_clamp/try_start_gated
