# pending が空気なら 3×3×3。即破壊＋押しっぱなしで current が上書きされても、先に prev を処理する。
...
execute if score @s overlimit.hd_pok matches 1 run function overlimit:enchant/hyper_dig/try_pos_prev
