# BM: 0.5/5/15/79.5 on 0..999 → d_max=4, c_max=54, g_max=204
scoreboard players set #bm_d_max overlimit.const 4
scoreboard players set #bm_c_max overlimit.const 54
scoreboard players set #bm_g_max overlimit.const 204
scoreboard players set #bm_follow overlimit.const 24
# NO budget ×1.0
...
# NO DISASTER on 0..499: 0.4%/2%/4% → max 1 / 9 / 19
