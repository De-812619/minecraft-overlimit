...
execute at @e[type=minecraft:marker,tag=overlimit.no_target,limit=1] run tag @p[predicate=overlimit:in_overworld,gamemode=!spectator] add overlimit.no_core
