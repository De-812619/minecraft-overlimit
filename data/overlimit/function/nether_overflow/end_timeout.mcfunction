...
title @a[predicate=overlimit:in_overworld] subtitle {"text":"時間切れ","color":"red"}
tellraw @a[predicate=overlimit:in_overworld] {"text":"敵を押し返せなかった。ゲート周辺がネザーに侵食される。","color":"red"}
