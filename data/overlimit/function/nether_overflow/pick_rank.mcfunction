# フェーズ固定＋ DISASTER 上書き（閾値は #no_dis1/2/3、脅威指数で更新）
...
execute if score #no_phase overlimit.const matches 1 if score #no_omen overlimit.const matches 1 run return run function overlimit:mob/make_danger
