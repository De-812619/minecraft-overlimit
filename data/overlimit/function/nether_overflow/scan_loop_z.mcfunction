...
function overlimit:nether_overflow/scan_loop_x
scoreboard players add #no_nz overlimit.const 2
execute if score #no_nz overlimit.const <= #no_rad overlimit.const run function overlimit:nether_overflow/scan_loop_z
