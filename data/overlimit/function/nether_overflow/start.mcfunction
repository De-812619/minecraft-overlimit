...
title @a[predicate=overlimit:in_overworld] title {"translate": "overlimit.event.nether_overflow","color":"dark_purple","bold":true}
title @a[predicate=overlimit:in_overworld] subtitle {"translate": "overlimit.subtitle.no_overflow","color":"gold"}
