...
execute if score #no_amod overlimit.const matches 0 run overlimit event_mobs no_anger
execute if score #no_amod overlimit.const matches 0 run overlimit event_mobs no_glow
execute if score #no_amod overlimit.const matches 0 run overlimit event_mobs no_unglow
