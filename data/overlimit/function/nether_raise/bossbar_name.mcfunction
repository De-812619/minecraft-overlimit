execute if score #nr_combat overlimit.const matches 0 run return run bossbar set overlimit:nether_raise name {"translate": "overlimit.bossbar.nether_raise.gather","color":"gold","bold":true}
