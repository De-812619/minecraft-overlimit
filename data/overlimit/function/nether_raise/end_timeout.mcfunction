...
title @a[predicate=overlimit:in_nether] subtitle {"translate": "overlimit.subtitle.timeout","color":"red"}
tellraw @a[predicate=overlimit:in_nether] {"translate": "overlimit.msg.nr.timeout","color":"red"}
