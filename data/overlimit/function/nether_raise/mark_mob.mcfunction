...
function overlimit:nether_raise/pick_rank
data merge entity @s {drop_chances:{head:0.0f,mainhand:0.0f}}
attribute @s minecraft:follow_range modifier add overlimit:nr_follow 24 add_value
tag @s add overlimit.scanned
function overlimit:nether_raise/anger
function overlimit:nether_raise/glow
