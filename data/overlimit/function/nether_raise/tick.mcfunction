...
execute unless score #nr_active overlimit.const matches 1 if score #nr_dwell overlimit.const >= #nr_dwell_max overlimit.const run function overlimit:nether_raise/try_start
