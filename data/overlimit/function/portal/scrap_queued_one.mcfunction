$execute in overlimit:blood_world positioned $(x) $(y) $(z) run forceload add ~-16 ~-16 ~16 ~16
...
execute if score #bw_scrap_wait overlimit.const matches 50.. run return run function overlimit:portal/scrap_queued_give_up
