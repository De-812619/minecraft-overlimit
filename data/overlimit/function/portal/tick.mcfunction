...
execute as @a[tag=overlimit.portal_held,tag=!overlimit.in_gate,tag=!overlimit.portal_arrive] run function overlimit:portal/release
execute as @a[tag=overlimit.in_gate,tag=!overlimit.portal_arrive] at @s unless score @s overlimit.portal_cd matches 1.. run function overlimit:portal/charge
