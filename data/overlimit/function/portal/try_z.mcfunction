...
execute unless function overlimit:portal/frame_z run return fail
execute if entity @e[type=minecraft:marker,tag=overlimit.bw_portal_z,distance=..3] run return fail
...
execute unless block ~ ~2 ~1 #minecraft:replaceable run return fail
function overlimit:portal/place_z
